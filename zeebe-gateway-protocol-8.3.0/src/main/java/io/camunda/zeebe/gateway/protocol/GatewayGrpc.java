...
public class GatewayGrpc {
	...
	public static class GatewayBlockingStub {
		...
		public GatewayOuterClass.CreateProcessInstanceResponse createProcessInstance(GatewayOuterClass.CreateProcessInstanceRequest request) {
			TracedMethod traced = NewRelic.getAgent().getTracedMethod();
			traced.addCustomAttribute("TenantId", request.getTenantId());
		...
		@Trace(dispatcher = true)
		public java.util.Iterator<GatewayOuterClass.ActivatedJob> streamActivatedJobs(GatewayOuterClass.StreamActivatedJobsRequest request) {
			TracedMethod traced = NewRelic.getAgent().getTracedMethod();
			traced.addCustomAttribute("Type", request.getType());
			traced.addCustomAttribute("Worker",request.getWorker());
			return Weaver.callOriginal();			
		}
	...
	public static class GatewayFutureStub {
		...
		@Trace
		public ListenableFuture<GatewayOuterClass.EvaluateDecisionResponse> evaluateDecision(GatewayOuterClass.EvaluateDecisionRequest request) {
			return Weaver.callOriginal();
		}
		...
		@Trace
		public ListenableFuture<GatewayOuterClass.ModifyProcessInstanceResponse> modifyProcessInstance(GatewayOuterClass.ModifyProcessInstanceRequest request) {
			return Weaver.callOriginal();
		}

		@Trace
		public ListenableFuture<GatewayOuterClass.DeleteResourceResponse> deleteResource(GatewayOuterClass.DeleteResourceRequest request) {
			return Weaver.callOriginal();
		}
